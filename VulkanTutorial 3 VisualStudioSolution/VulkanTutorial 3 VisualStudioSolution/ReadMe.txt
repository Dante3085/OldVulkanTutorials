========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 3 VisualStudioSolution-Projektübersicht
========================================================================

Diese VulkanTutorial 3 VisualStudioSolution-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 3 VisualStudioSolution-Anwendung besteht.


VulkanTutorial 3 VisualStudioSolution.vcxproj
...
VulkanTutorial 3 VisualStudioSolution.vcxproj.filters
...
VulkanTutorial 3 VisualStudioSolution.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 3 VisualStudioSolution.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
