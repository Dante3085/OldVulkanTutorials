========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 8 vkEnumPhyDevVkPhysDe-Projektübersicht
========================================================================

Diese VulkanTutorial 8 vkEnumPhyDevVkPhysDe-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 8 vkEnumPhyDevVkPhysDe-Anwendung besteht.


VulkanTutorial 8 vkEnumPhyDevVkPhysDe.vcxproj
...
VulkanTutorial 8 vkEnumPhyDevVkPhysDe.vcxproj.filters
...
VulkanTutorial 8 vkEnumPhyDevVkPhysDe.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 8 vkEnumPhyDevVkPhysDe.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
