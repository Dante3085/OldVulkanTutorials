========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 14 VkDeviceCreateInfo-Projektübersicht
========================================================================

Diese VulkanTutorial 14 VkDeviceCreateInfo-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 14 VkDeviceCreateInfo-Anwendung besteht.


VulkanTutorial 14 VkDeviceCreateInfo.vcxproj
...
VulkanTutorial 14 VkDeviceCreateInfo.vcxproj.filters
...
VulkanTutorial 14 VkDeviceCreateInfo.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 14 VkDeviceCreateInfo.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
