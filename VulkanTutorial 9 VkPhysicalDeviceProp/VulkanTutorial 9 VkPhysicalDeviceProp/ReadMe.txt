========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 9 VkPhysicalDeviceProp-Projektübersicht
========================================================================

Diese VulkanTutorial 9 VkPhysicalDeviceProp-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 9 VkPhysicalDeviceProp-Anwendung besteht.


VulkanTutorial 9 VkPhysicalDeviceProp.vcxproj
...
VulkanTutorial 9 VkPhysicalDeviceProp.vcxproj.filters
...
VulkanTutorial 9 VkPhysicalDeviceProp.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 9 VkPhysicalDeviceProp.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
