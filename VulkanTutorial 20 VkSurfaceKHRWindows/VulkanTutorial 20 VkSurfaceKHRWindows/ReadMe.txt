========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 20 VkSurfaceKHRWindows-Projektübersicht
========================================================================

Diese VulkanTutorial 20 VkSurfaceKHRWindows-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 20 VkSurfaceKHRWindows-Anwendung besteht.


VulkanTutorial 20 VkSurfaceKHRWindows.vcxproj
...
VulkanTutorial 20 VkSurfaceKHRWindows.vcxproj.filters
...
VulkanTutorial 20 VkSurfaceKHRWindows.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 20 VkSurfaceKHRWindows.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
