========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 17 Extensions-Projektübersicht
========================================================================

Diese VulkanTutorial 17 Extensions-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 17 Extensions-Anwendung besteht.


VulkanTutorial 17 Extensions.vcxproj
...
VulkanTutorial 17 Extensions.vcxproj.filters
...
VulkanTutorial 17 Extensions.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 17 Extensions.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
