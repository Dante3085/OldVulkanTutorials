========================================================================
    KONSOLENANWENDUNG: Vulkan_ProjectPreset-Projektübersicht
========================================================================

Diese Vulkan_ProjectPreset-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Vulkan_ProjectPreset-Anwendung besteht.


Vulkan_ProjectPreset.vcxproj
...
Vulkan_ProjectPreset.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Vulkan_ProjectPreset.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
