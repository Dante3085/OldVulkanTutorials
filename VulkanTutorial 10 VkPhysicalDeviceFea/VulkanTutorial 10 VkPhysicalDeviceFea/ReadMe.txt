========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 10 VkPhysicalDeviceFea-Projektübersicht
========================================================================

Diese VulkanTutorial 10 VkPhysicalDeviceFea-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 10 VkPhysicalDeviceFea-Anwendung besteht.


VulkanTutorial 10 VkPhysicalDeviceFea.vcxproj
...
VulkanTutorial 10 VkPhysicalDeviceFea.vcxproj.filters
...
VulkanTutorial 10 VkPhysicalDeviceFea.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 10 VkPhysicalDeviceFea.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
