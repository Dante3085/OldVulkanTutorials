========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 12 VkQueueFamiliyPrope-Projektübersicht
========================================================================

Diese VulkanTutorial 12 VkQueueFamiliyPrope-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 12 VkQueueFamiliyPrope-Anwendung besteht.


VulkanTutorial 12 VkQueueFamiliyPrope.vcxproj
...
VulkanTutorial 12 VkQueueFamiliyPrope.vcxproj.filters
...
VulkanTutorial 12 VkQueueFamiliyPrope.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 12 VkQueueFamiliyPrope.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
