========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 13 VkDeviceQueueCreate-Projektübersicht
========================================================================

Diese VulkanTutorial 13 VkDeviceQueueCreate-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 13 VkDeviceQueueCreate-Anwendung besteht.


VulkanTutorial 13 VkDeviceQueueCreate.vcxproj
...
VulkanTutorial 13 VkDeviceQueueCreate.vcxproj.filters
...
VulkanTutorial 13 VkDeviceQueueCreate.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 13 VkDeviceQueueCreate.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
