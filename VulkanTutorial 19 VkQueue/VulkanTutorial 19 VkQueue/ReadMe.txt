========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 19 VkQueue-Projektübersicht
========================================================================

Diese VulkanTutorial 19 VkQueue-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 19 VkQueue-Anwendung besteht.


VulkanTutorial 19 VkQueue.vcxproj
...
VulkanTutorial 19 VkQueue.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 19 VkQueue.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
