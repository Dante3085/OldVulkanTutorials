========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 4 VkApplicationInfo-Projektübersicht
========================================================================

Diese VulkanTutorial 4 VkApplicationInfo-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 4 VkApplicationInfo-Anwendung besteht.


VulkanTutorial 4 VkApplicationInfo.vcxproj
...
VulkanTutorial 4 VkApplicationInfo.vcxproj.filters
...
VulkanTutorial 4 VkApplicationInfo.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 4 VkApplicationInfo.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
