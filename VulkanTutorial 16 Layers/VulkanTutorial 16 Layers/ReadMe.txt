========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 16 Layers-Projektübersicht
========================================================================

Diese VulkanTutorial 16 Layers-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 16 Layers-Anwendung besteht.


VulkanTutorial 16 Layers.vcxproj
...
VulkanTutorial 16 Layers.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 16 Layers.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
