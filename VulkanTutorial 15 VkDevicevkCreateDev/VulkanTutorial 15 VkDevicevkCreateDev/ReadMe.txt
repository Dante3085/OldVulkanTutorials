========================================================================
    KONSOLENANWENDUNG: VulkanTutorial 15 VkDevicevkCreateDev-Projektübersicht
========================================================================

Diese VulkanTutorial 15 VkDevicevkCreateDev-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre VulkanTutorial 15 VkDevicevkCreateDev-Anwendung besteht.


VulkanTutorial 15 VkDevicevkCreateDev.vcxproj
...
VulkanTutorial 15 VkDevicevkCreateDev.vcxproj.filters
...
VulkanTutorial 15 VkDevicevkCreateDev.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen VulkanTutorial 15 VkDevicevkCreateDev.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
